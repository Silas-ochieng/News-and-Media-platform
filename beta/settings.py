...
EMAIL_BACKEND = 'accounts.email_backend.LoggingEmailBackend' if IS_PRODUCTION else os.environ.get('EMAIL_BACKEND', 'accounts.email_backend.LoggingEmailBackend')
